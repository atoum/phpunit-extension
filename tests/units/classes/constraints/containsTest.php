...
use mageekguy\atoum;
use mageekguy\atoum\phpunit\constraints\contains as testedClass;
...
class contains extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAssertArrayContainsObject()
    {
        ...
        $constraint = new testedClass($expected);
        $this->assertSame($constraint, $constraint->evaluate([$expected]));
    ...
    public function testAssertIteratorContainsObject()
    {
        ...
        $actual = new \testIterator([new \stdClass()]);
    ...
    public function testAssertIteratorContainsString()
    {
        $expected = 'foo';
        $constraint = new testedClass($expected);
        $this->assertSame($constraint, $constraint->evaluate(new \testIterator([$expected])));

        $actual = new \testIterator(['bar']);
